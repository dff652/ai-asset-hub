...
| N7 | P2 | 🚧 **E4 设置与 i18n** | N7.0–N7.3 已完成：完整双语目录、安全偏好 Core、设置页、auto/zh-CN/en、临时 override、显式原子保存及真实 PTY 重启验收；下一步 N7.4 接入显示密度和仅预填的首选资产库，N7.5 再做正式包验收 |
...
有双语 golden、零写入测试和变异验证。显示密度和首选资产库预填仍待 N7.4；
